(function (global) {
  ...
  var computer = _.assign({}, player, {
    ...
    play: function () {
      ...
      setTimeout(function () {
        ...
        self.game.fire(this, line, col, function (hasSucced) {
          ...
          if (hasSucced)
            self.game.miniGrid.querySelector(
              ".row:nth-child(" +
                (col + 1) +
                ") .cell:nth-child(" +
                (line + 1) +
                ")"
            ).style.background = "#c55";
          else
            self.game.miniGrid.querySelector(
              ".row:nth-child(" +
                (col + 1) +
    ...
    placeShips: function (callback) {
      ...
      var ship_3 = false;
      var ship_4 = false;
      while (ship_1 == false) ship_1 = this.placeShip(5);
      while (ship_2 == false) ship_2 = this.placeShip(6);
      while (ship_3 == false) ship_3 = this.placeShip(7);
      while (ship_4 == false) ship_4 = this.placeShip(8);
    ...
    placeShip: function (id) {
      ...
      if (id == 5 || id == 6) {
        ...
        if (pos == 0) {
          ...
          while (i < life) {
            if (this.grid[posx + i][posy] != 0) return false;
            i++;
          }
          i = 0;
          while (i < life) {
          ...
          while (i < life) {
            if (this.grid[posx][posy + i] != 0) return false;
            i++;
          }
          i = 0;
          while (i < life) {
